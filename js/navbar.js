...
navbar.innerHTML = `
    ...
    <div id="navRight">
        ...
        <button class="navButton" id="messagesButton">Messages</button>
        <button class="navButton" id="notificationsButton">Notifications</button>
        <button class="navButton" id="profileButton">Profile</button>
        <button class="navButton" id="logoutButton">Logout</button>
    </div>
`;
